        ...
        >
          ...
          <div className="relative z-10 grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div className="space-y-6">
              <div className="inline-flex w-fit items-center gap-3 rounded-md border border-slate-200 bg-slate-50 px-4 py-2 text-xs font-semibold tracking-[0.18em] text-slate-600 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300">
              ...
              <div className="grid gap-4 pt-6 sm:grid-cols-3">
                {metrics.map((item) => (
                  <div key={item.label} className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-950">
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-950">
                <p className="text-xs uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">协作方式</p>
                <p className="mt-2 text-base font-semibold text-slate-900 dark:text-slate-100">
                  以流程驱动工程交付
                </p>
                <p className="mt-3 text-sm text-slate-600 dark:text-slate-300">
                  通过规范化的评审、测试与复盘，将经验沉淀为团队能力。
                </p>
              </div>
            </div>
          </div>
        ...
        >
          <div className="flex flex-col gap-8">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
              <div>
                <p className="text-xs uppercase tracking-[0.25em] text-slate-500 dark:text-slate-400">核心方向</p>
            ...
            <div className="grid gap-6 md:grid-cols-3">
              {focusAreas.map((item) => (
                <div key={item.title} className="rounded-xl border border-slate-200 bg-slate-50 p-6 dark:border-slate-800 dark:bg-slate-900">
        ...
        >
          <div className="flex flex-col gap-8">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              <div>
                <p className="text-xs uppercase tracking-[0.25em] text-slate-500 dark:text-slate-400">工程计划</p>
                <h2 className="mt-3 text-3xl font-semibold text-slate-900 sm:text-4xl dark:text-slate-100">
                  以工程交付视角组织每一条计划。
                </h2>
              </div>
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              {programs.map((program) => (
                <div key={program.title} className="rounded-xl border border-slate-200 bg-slate-50 p-6 dark:border-slate-800 dark:bg-slate-900">
        ...
        >
          <div className="flex flex-col gap-10 lg:grid lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
            <div>
              ...
              <div className="mt-6 inline-flex items-center gap-3 rounded-md border border-slate-200 bg-slate-50 px-5 py-4 dark:border-slate-800 dark:bg-slate-900">
            ...
            <div className="grid gap-6">
              {community.map((card) => (
                <div key={card.title} className="rounded-xl border border-slate-200 bg-slate-50 p-6 dark:border-slate-800 dark:bg-slate-900">
